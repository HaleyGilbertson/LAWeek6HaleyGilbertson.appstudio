...
const cacheName = 'LAWeek6HaleyGilbertson-2021-10-01 11:25:09.409180'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek6HaleyGilbertson'.length) === 'LAWeek6HaleyGilbertson') {
